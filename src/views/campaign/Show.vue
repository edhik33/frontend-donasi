                ...
                <div class="card-body">
                 ...
                 <img :src="campaign.image" class="w-100 rounded lazy" style="object-fit: cover">
                  ...
                  <h6>{{ campaign.crowdfunding }}    <img :src="campaign.logo" class="align-items-left" style="width:20px;"></h6> 
                    ...
                    <router-link :to="{name: 'form', params: {slug: campaign.slug }}" class="btn btn-success shadow-sm p-2 mb-3 bg-success text-white rounded  mx-auto" style="width:100%;font-size:15px"> Donasi <i class="fa fa-long-arrow-alt-right"></i>  </router-link>
